...
let projects = [
  {
    ...
    url: 'https://www.bincinternational.nl/',
  },
  {
    image: 'textures/krijnvlan.png',
    url: 'https://krijnvanlankveld.com/',
  },
  {
    image: 'textures/stagemarkt.png',
    url: 'https://stagemarkt.nl/',
  },
  {
    image: 'textures/test1.png',
    url: 'https://www.hpcarcare.nl/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Krijn', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
